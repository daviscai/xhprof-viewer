...
if ($ui->display_calls) {
	echo Utils::td_num($data2[$ui->fn]['ct'] - $data1[$ui->fn]['ct'], $ui->config->format_cbk['ct'], ($ui->sort == 'ct'));
	echo Utils::td_pct($data2[$ui->fn]['ct'] - $data1[$ui->fn]['ct'], $ui->totals['ct'], ($ui->sort == 'ct'));
}

foreach ($ui->metrics as $metric) {
	// Inclusive metric
	echo Utils::td_num($data2[$ui->fn][$metric] - $data1[$ui->fn][$metric], $ui->config->format_cbk[$metric], ($ui->sort == $metric));
	echo Utils::td_pct($data2[$ui->fn][$metric] - $data1[$ui->fn][$metric], $ui->totals[$metric], ($ui->sort == $metric));
}
